...
public class NavigationTransition
{
    ...
    /// </summary>
    private void AnimateBackground(FragmentTransaction transaction, bool isPush)
    {
        switch (_renderer.BackgroundAnimation)
        {
            ...
            case BackgroundAnimation.Flip:
                transaction.SetCustomAnimations(
                    Resource.Animation.flip_in,
                    Resource.Animation.flip_out,
                    Resource.Animation.flip_out,
                    Resource.Animation.flip_in
                );
                break;
            case BackgroundAnimation.SlideFromLeft:
                ...
                {
                    transaction.SetCustomAnimations(
                        Resource.Animation.enter_left,
                        Resource.Animation.exit_right,
                        Resource.Animation.enter_right,
                        Resource.Animation.exit_left
                    );
                }
                else
                {
            ...
            case BackgroundAnimation.SlideFromTop:
                ...
                {
                    transaction.SetCustomAnimations(
                        Resource.Animation.enter_top,
                        Resource.Animation.exit_bottom,
                        Resource.Animation.enter_bottom,
                        Resource.Animation.exit_top
                    );
                }
                else
                {
