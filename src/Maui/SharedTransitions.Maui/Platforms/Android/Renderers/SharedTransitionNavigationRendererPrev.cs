...
//     public class SharedTransitionNavigationRendererPrev : NavigationViewHandler, ITransitionRenderer
//     {
...
//
//         public SharedTransitionNavigationRendererPrev()
//         {
//             SupportFragmentManager = ((MauiAppCompatActivity)Context).SupportFragmentManager;
//
...
//         {
//             var view = base.CreatePlatformView().JavaCast<FragmentContainerView>();
//             return view;
//         }
//
...
//             PropertiesContainer = VirtualView.NavigationStack.Count == 1
//                 ? page
//                 : ((INavigationPageController)VirtualView).Peek(1);
//
//             /*
//              * IMPORTANT!
//              *
...
//             PropertiesContainer = ((INavigationPageController)VirtualView).Peek(1);
//
//             /*
...
//                 RecreateFragment(((INavigationPageController)VirtualView).Pages.FirstOrDefault());
//
//             _popToRoot = true;
...
//                 TransitionMap = ((ISharedTransitionContainer)VirtualView).TransitionMap;
//
...
//         {
//             ((ISharedTransitionContainer)VirtualView).SendTransitionStarted(TransitionArgs());
//         }
//
//         public void SharedTransitionEnded()
//         {
//             ((ISharedTransitionContainer)VirtualView).SendTransitionEnded(TransitionArgs());
//         }
//
//         public void SharedTransitionCancelled()
//         {
//             ((ISharedTransitionContainer)VirtualView).SendTransitionCancelled(TransitionArgs());
//         }
//
